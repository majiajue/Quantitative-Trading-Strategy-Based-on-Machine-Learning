...
def on_data(context: Context):
    ...
    # factor的注册频率默认为日频
    factor=get_reg_factor(reg_idx=context.reg_factor[0], target_indices=(), length=10, df=True)
    ...
    # 预测
    model = pickle.load(open("XGboost_ret0.03_5factor.pickle.dat", "rb"))
...
if __name__ == "__main__":
    ...
    a = run_backtest('XGBoost_2016_2018_0.03',target_list=tarlist['code'].tolist(),file_path='.', begin_date=begin_date,
